...
// 			StoreCtrl.clearStoreModal();
        ...
        searchStore: function (page) {
            ...
            $.ajax({
                ...
                , success: function (data) {
                    ...
                    $("#joinCompleteBtn").css('display', 'inline-block');
            ...
            if (schAddress2 !== "") {
	            $.ajax({
	                ...
	                , success: function (data) {
	                    ...
	                    for (var i = 0; i < data.length; i++) {
	                        var add3Option = "<option value='" + data[i] + "'>" + data[i] + "</option>";
        ...
        completeStore: function () {
            ...
            if (callStoreGubun === "order") {
                ...
                //var lsStoreCode = $("input:radio[name='shopResult']:checked").val();
            ...
            naver.maps.Service.geocode({
				...
				*/
                ...
                var markerOptions = {
                    ...
                    map: map,
                    icon: {
                        url: '../pc/img/common/apimap_icon_uplus.png',
